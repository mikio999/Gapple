    ...
    '신체 운동 • 건강': [
      {
        '신체활동 즐기기': [
          '신체를 인식하고 움직인다.',
          '신체 운동능력을 조절한다.',
          '기초적인 이동 동작, 제자리 동작, 도구를 이용한 동작을 한다.',
      ...
      },
      {
        '안전하게 생활하기': [
          ...
          '교통안전 규칙을 지킨다.',
          '안전사고, 화재, 재난, 학대, 유괴 등에 대처하는 방법을 알고 행동한다.',
        ],
      },
    ],
  },
  {
    의사소통: [
      ...
      },
      {
        '읽기와 쓰기에 관심가지기': [
          '말과 글의 관계에 관심을 가져간다.',
          '주변의 상징, 글자 등의 읽기에 관심을 가져간다.',
          '자신의 생각을 글자와 비슷한 형태나 글자로 표현한다.',
        ],
      },
      {
        '책과 이야기 즐기기': [
          '책 읽기에 관심을 가지고 상상하기를 즐긴다.',
          '동화, 동시에서 말과 글의 재미를 느낀다.',
          '말놀이와 이야기 짓기를 즐긴다.',
        ],
      },
    ],
