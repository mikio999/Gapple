      ...
      <CustomItem>
        ...
        <div className="flex flex-col mb-2">
          <div className="flex flex-col laptop:flex-row my-4">
            <span className="text-white bg-slate-700 px-3 py-1 rounded-full mr-2 font-light">
              {data.age}세
            </span>
            <span className="text-white bg-slate-700 px-3 py-1 rounded-full mr-2 font-light">
              {data.activity_type}
            </span>
            <span className="text-white bg-slate-700 px-3 py-1 rounded-full font-light laptop:mt-0 mt-2">
              {data.subject}
            </span>
          </div>
          ...
          <ul className="px-4 py-2">
            {data.content_subtitles.map((subtitle, index) => (
              ...
              >
                <div className="flex justify-center items-center text-slate-400 w-4 h-4 rounded-full mr-2">
                  {index + 1}
                </div>
                {subtitle}
              </li>
          ...
          <span className="flex justify-end mr-4 text-slate-600 hover:text-slate-400 text-sm">
            ...더보기
          </span>
        </div>
